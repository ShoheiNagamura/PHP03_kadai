...
$sql = 'INSERT INTO job_project(id, jobName, status, place, schedule,TransportationCosts,deadline, content,created_time, update_time) 
        VALUES (NULL, :jobName ,:status, :place, :schedule, :TransportationCosts, :deadline, :content,now(), now())';
